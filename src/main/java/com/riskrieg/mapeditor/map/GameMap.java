...
public class GameMap {
  ...
  private boolean isValid(String name) {
    return GsonUtil.loadFromJson(Constants.MAP_PATH + name + "/" + name + ".json", MapInfo.class) != null
        && GsonUtil.loadFromJson(Constants.MAP_PATH + name + "/graph/" + name + ".json", MapData.class) != null;
  }

  private MapInfo getInfo() {
    return (MapInfo) GsonUtil.loadFromJson(Constants.MAP_PATH + name + "/" + name + ".json", MapInfo.class);
  }
  ...
  private MapData getData() {
    return (MapData) GsonUtil.loadFromJson(Constants.MAP_PATH + name + "/graph/" + name + ".json", new TypeToken<MapData>() {
    }.getType());
  }
